...
DO_APP_CLASS(AmongUsClient, "Assembly-CSharp, AmongUsClient");
DO_APP_CLASS(GameData, "Assembly-CSharp, GameData");
...
DO_APP_CLASS(Camera, "UnityEngine.CoreModule, Camera");
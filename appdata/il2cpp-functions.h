...
//DO_APP_FUNC(void, AmongUsClient_OnStartGame, (AmongUsClient* __this, MethodInfo* method), "Assembly-CSharp, System.Void AmongUsClient::OnStartGame()");
...
//DO_APP_FUNC(void, ElectricTask_FixedUpdate, (ElectricTask* __this, MethodInfo* method), "Assembly-CSharp, System.Void ElectricTask::FixedUpdate()");
//DO_APP_FUNC(void, NoOxyTask_FixedUpdate, (NoOxyTask* __this, MethodInfo* method), "Assembly-CSharp, System.Void NoOxyTask::FixedUpdate()");
//DO_APP_FUNC(void, HqHudOverrideTask_FixedUpdate, (HqHudOverrideTask * __this, MethodInfo * method), "Assembly-CSharp, System.Void HqHudOverrideTask::FixedUpdate()");
//DO_APP_FUNC(void, HudOverrideTask_FixedUpdate, (HudOverrideTask * __this, MethodInfo * method), "Assembly-CSharp, System.Void HudOverrideTask::FixedUpdate()");
//DO_APP_FUNC(void, ReactorTask_FixedUpdate, (ReactorTask * __this, MethodInfo * method), "Assembly-CSharp, System.Void ReactorTask::FixedUpdate()");
...
//DO_APP_FUNC(void, PlainDoor_SetDoorway, (PlainDoor* __this, bool open, MethodInfo* method), "Assembly-CSharp, System.Void AutoOpenDoor::SetDoorway(System.Boolean)");
